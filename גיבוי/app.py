...
def company_manager_proxy():
    ...
    try:
        ...
        if is_local_dev:
            ...
            print(f"   🌐 PRODUCTION MODE - Using remote parking server")
        ...
        # בניית URL - פשוט כמו שהיה
        if 'CustomerMediaWebService' in endpoint:
            # אם זה CustomerMediaWebService, בלי /api
        ...
        try:
            ...
            print(f"   📝 Response text preview: {response.text[:200] if response.text else 'Empty'}")
